 ...
 useEffect(() => {
    ...
    function fetch_report(url) {
        fetch(url)
            ...
            .then((data) => {
                console.log(data.show_yearly_orders_chart);
                console.log(data.show_yearly_orders_chart);
                setDates(data.show_yearly_orders_chart.Dates);
                setData(data.show_yearly_orders_chart.Data);
            })
            .catch((error) => {
        ...
        <div className="container mx-auto mt-8">
            <div className="flex flex-wrap">
                ...
                <div className="w-full md:w-3/4 mt-4">
                        <h1 className="text-3xl font-bold">Yearly Reports</h1>
